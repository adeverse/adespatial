...
#' @param binary.mat Site (n rows) by link (k columns) matrix. The 1s in the matrix represents the presence of a link influencing a site, directly or indirectly, otherwise the values are 0s.
#' @param weight Vector of weights of length k, to be applied to the links.
#' @param rm.link0 Logical (\code{TRUE}, \code{FALSE}) determining if the links directly connecting a site to the origin (site 0) should be removed. Default value: \code{FALSE}. This parameter is only used when an object of class \code{build.binary} is provided to the function.
#' @param print.binary.mat Logical (\code{TRUE}, \code{FALSE}) determining if the site-by-link matrix used in the analysis should be printed.
#'
#' @details
#'
...
#' \item{\code{vectors}}{A matrix of eigenvector. Each column is an AEM eigenfunction (or variable).}
#' \item{\code{mod.binary.mat}}{A site-by-link matrix modified through the function.}
#' @references
#'
