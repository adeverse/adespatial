...
#'
#' @param xy A 2-columns matrix or data frame containing a set of X and Y coordinates.
#' @param angle Numeric. A scalar giving the angle at which the points should be rotated. The angle is in radians.
#' 
#' @return
#' 
