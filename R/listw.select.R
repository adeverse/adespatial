...
#'   W_sel <- listw.select(Y_sampled, candidates,
#'     MEM.autocor = "positive", method = "FWD",
...
"listw.select" <- function(
  ...
  res.tmp <- lapply(candidates, mem.select,
    x = x, MEM.autocor = MEM.autocor,
